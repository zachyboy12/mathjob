...
if __name__ == '__main__':
    ...
    def demo1():
        box(310, 5, 'yellow', (-160, -130))
        bargraph('light green', startcoor=(-50, 0))
        histogram('light pink', startcoor=(-150, -2))
        linegraph(times=3, startcoor=(-50, 0))
        texttag('Things I think about', 'light pink', ('Arial', 12, 'bold'), (0, -100))
        texttag('Green - programming    Blue - Nintendo    Pink - Other', 'light green', ('Arial', 9, 'normal'), (0, 150))
        savechart('thisisanexample')
        s.mainloop()
        
        
    def demo2():
        box(450, 5, 'light green', (-80, -200))  
        texttag('Line graph made by pytchart', 'light pink', ('Arial', 15, 'bold'), (150, 200))
        texttag('$10000 ---', 'light blue', ('Arial', 15, 'normal'), (-30, 100))
        texttag('$10 ---', 'light blue', ('Arial', 15, 'normal'), (-30, -100))
        linegraph('light blue', 0.070, 10, 1000, 10, 10, (-80, -200))
        linegraph('light green', 0.070, 10, 1000, 10, 10, (-80, -200))
        linegraph('light pink', 0.070, 10, 1000, 10, 10, (-80, -200))
        savechart('thisisanexample')
        s.mainloop()


    def demo3():
        box(310, 5, 'light green', (-160, -130))
        bubblegraph(linelength=435, times=6, startcoor=(-160, -130))
        bubblegraph(color='light pink', linelength=435, times=6, startcoor=(-160, -130))
        texttag('My life', 'light pink', ('Arial', 20, 'bold'), (0, -100))
        texttag('Blue - Eat    Pink - Other', 'light green', ('Arial', 13, 'normal'), (0, 150))
        savechart('thisisanexample')
        s.mainloop()
        

    def demo4():
        box(400, 5, 'light green', (-200, -130))
        sidebargraph(pxperstep=0.40, startcoor=(-195, 100))
        texttag('Money made by a company in ten days', 'light pink',
        ('Arial', 15, 'bold'), (5, 200))
        savechart('thisisanexample')
        s.mainloop()
    ...
    def demo5():
        while True:
            delay(3)
            randomgraph('light pink', 0.07, 5, 1000, 10, 10, 510, (0, 0))
            delay(3)
            clearall()
            os.system('clear')     
            

    # Check cool demos by calling them!
